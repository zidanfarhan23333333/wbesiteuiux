    ...
    >
      <div className="container relative" ref={parallaxRef}>
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          <div className="relative z-10 p-1 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <Generating className="absolute left-1/2 bottom-8 md:w-[31rem] md:translate-x-[-50%]" />
          ...
          <div className="absolute top-[50%] left-1/2 w-full -translate-x-1/2 -translate-y-1/2 md:w-[138%] lg:w-[100%]">
            <img
              src={heroBackground}
              className="w-full"
              width={1440}
